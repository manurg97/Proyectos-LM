...
<style>
  ...
  /* Lista sin bullets y con indentación */
  #indice-fijo ul {
    list-style: none;
    padding-left: 10px;
  }
  ...
  /* Para que los textos no se vean demasiado juntos */
  #indice-fijo li {
    margin-bottom: 6px;
  }
</style>
...
<div id="indice-fijo">
  <strong>🗂️ Índice</strong>
  <ul>
    <li>🌍 Navegación rápida</li>
    <li>🔎 Más información</li>
    <li>❓ ¿Qué es la contaminación ambiental?</li>
    <ul>
      <li>📚 Explicación ampliada</li>
      <li>☁️ Tipo de contaminación aérea</li>
      <ul>
        <li>Contaminación del aire</li>
        <li>Causas principales</li>
        <li>Consecuencias</li>
      </ul>
      <li>💧 Tipo de contaminación hídrica</li>
      <ul>
        <li>Contaminación del agua</li>
        <li>Causas</li>
      </ul>
      <li>🌱 Tipo de contaminación terrestre</li>
      <ul>
        <li>Contaminación del suelo</li>
      </ul>
    </ul>
    <li>⚠️ Impactos de la contaminación ambiental</li>
